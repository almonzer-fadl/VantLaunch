...
export function BeforeAfterSlider({
  ...
  return (
    <div
      ref={containerRef}
      className={`relative select-none overflow-hidden rounded-2xl border border-black/10 bg-white shadow-mid ${className}`}
      onPointerDown={(e) => {
    ...
    >
      ...
      {/* Before (full width, clipped right) */}
      ...
      >
        <div className="flex h-12 w-12 items-center justify-center rounded-full bg-white shadow-mid ring-1 ring-black/10 sm:h-14 sm:w-14">
          <motion.div
