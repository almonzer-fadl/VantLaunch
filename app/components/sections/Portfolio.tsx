...
const PROJECTS = [
  {
    slug: "teramotors",
    name: "TeraMotors",
    tagline: "Saved 18 hours per week and replaced 4 disconnected tools.",
    ...
    system: "A unified dashboard for job cards, invoicing, customer records, and reporting — replacing paper, Excel, WhatsApp, and manual billing.",
    replaced: "Paper job cards, manual invoicing, Excel spreadsheets, WhatsApp customer tracking, disconnected billing.",
    value: "18 hours of admin eliminated per week. Every job, part, and invoice visible in one dashboard. Digital service records. Automatic billing.",
