  ...
  return (
    <section id="portfolio" className="border-t border-black/10 bg-[#fffaf0] px-6 py-16 text-[#11100e] sm:py-24 md:py-32">
      <div className="mx-auto max-w-7xl">
        ...
        >
          <span className="mb-4 inline-flex rounded-full border border-black/10 bg-white px-3 py-1 text-xs font-bold uppercase tracking-[0.16em] text-[#74695b]">Proof</span>
                ...
                <div className="flex flex-1 flex-col p-5 sm:p-8">
                  ...
                  <div className="mt-5 space-y-3">
                    <div>
                      ...
                      <p className="mt-1 text-sm leading-relaxed text-[#5f5548]">{project.before}</p>
                    </div>
                    <div>
                      <span className="text-[10px] font-bold uppercase tracking-[0.14em] text-[#74695b]">System Built</span>
                      <p className="mt-1 text-sm leading-relaxed text-[#5f5548]">{project.system}</p>
                    </div>
                  </div>
            ...
            {PROJECTS.filter(p => !p.featured).map((project, i) => (
              ...
              >
                ...
                <div className="mt-4 flex-1 rounded-lg border border-black/[0.04] bg-[#f8f6ef] p-3">
                  ...
                  <p className="mt-1 text-xs leading-relaxed text-[#5f5548]">{project.replaced}</p>
                </div>
              </motion.div>
            ))}
          </div>
