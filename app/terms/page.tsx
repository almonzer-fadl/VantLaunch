  ...
  return (
    <main className="min-h-screen bg-[#fbf4e2] px-6 py-16 text-[#695b45]">
      <article className="mx-auto max-w-3xl space-y-6">
        ...
        <h1 className="text-4xl font-bold text-[#17140d]">Terms</h1>
        ...
        <p>
          ...
          <a className="font-semibold text-[#00401f] underline" href={`mailto:${CONTACT_EMAILS.product}`}>{CONTACT_EMAILS.product}</a>.
